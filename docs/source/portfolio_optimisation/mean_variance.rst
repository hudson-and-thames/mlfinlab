...
.. warning::
    ...
    Please switch to the `PortfolioLab package <https://hudson-and-thames-portfoliolab.readthedocs-hosted.com/en/latest/modern_portfolio_theory/mean_variance.html>`__
...
.. raw:: html
    ...
    if (String(window.location).indexOf("readthedocs") !== -1) {
        ...
        window.location.replace('https://hudson-and-thames-portfoliolab.readthedocs-hosted.com/en/latest/modern_portfolio_theory/mean_variance.html');
    }
    </script>
