...
.. warning::
    ...
    Please switch to the `PortfolioLab package <https://hudson-and-thames-portfoliolab.readthedocs-hosted.com/en/latest/clustering/hierarchical_equal_risk_contribution.html>`__
...
.. automodule:: mlfinlab.portfolio_optimization.clustering.herc
...
.. raw:: html
    ...
    if (String(window.location).indexOf("readthedocs") !== -1) {
        ...
        window.location.replace('https://hudson-and-thames-portfoliolab.readthedocs-hosted.com/en/latest/clustering/hierarchical_equal_risk_contribution.html');
    }
    </script>
