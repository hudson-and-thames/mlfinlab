...
SequentiallyBootstrappedBaggingClassifier and SequentiallyBootstrappedBaggingRegressor extend `sklearn <https://scikit-learn.org/>`_'s BaggingClassifier/Regressor by using Sequential Bootstrapping instead of random sampling.
