...
Correlation Matrix show the matrix that are sorted by their relevance. Optimized Clusters show the optimal number of clustres and each of the clusters' contents.
