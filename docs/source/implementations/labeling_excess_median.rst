...
In this method, a cross sectional dataset of close prices of many different tickers it used. The median return at each time index
...
* `Label Excess Over Median Example`_
