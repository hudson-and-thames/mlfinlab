...
def return_over_benchmark(prices, benchmark=0, binary=False):
    """
    ...
    :param prices: (pd.Series or pd.DataFrame) Time indexed prices to find labels for. NaN values are fine and will
                result in a NaN label.
