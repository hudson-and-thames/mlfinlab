...
class AbstractModelFingerprint(ABC):
    ...
    def __init__(self):
        ...
        self.feature_values = None  # Feature values used in fingerpints analysis
    ...
    def get_effects(self) -> Tuple:
        ...
        :return: (tuple) of linear, non-linear and pairwise effects dictionaries (raw values and normalised)
        """
