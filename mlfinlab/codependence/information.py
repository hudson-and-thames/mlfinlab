"""
Implementations of mutual info and variation of information (VI) codependence measures from
...
def get_optimal_number_of_bins(num_obs: int, corr_coef=None) -> int:
    ...
    The algorithm is described at https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3512994&download=yes (p.26)
