...
class M2N:
    ...
    def get_moments(self, parameters, return_result=False):
        ...
        """
        u_1, u_2, s_1, s_2, p_1 = parameters  # Expanded mixture parameters to indvidual variables for clarity.
    ...
    def single_fit_loop(self, epsilon=10**-5, factor=5, variant=1, max_iter=100_000):
        ...
        self.parameters = [0 for i in range(5)]  # Initialize the parameter list.
    ...
    def mp_fit(self, epsilon=10**-5, factor=5, n_runs=1, variant=1, max_iter=100_000, num_workers=-1):
        """
        Parallelized implementation of the 'single_fit_loop' method. Makes use of dask.delayed to
        execute multiple calls of 'single_fit_loop' in parallel.
