def calculate_mean_historical_returns(asset_prices, resample_by, frequency=252):
    '''
...
def calculate_exponential_historical_returns(asset_prices, resample_by, frequency=252, span=500):
    '''
...
def calculate_returns(asset_prices, resample_by):
    '''
    Calculate the annualised mean historical returns from asset price data
