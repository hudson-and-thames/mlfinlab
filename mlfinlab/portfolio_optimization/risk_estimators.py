...
class RiskEstimators:
    ...
    @ staticmethod
    def de_noised_cov(cov, tn_relation, kde_bwidth):
        """
        ...
        def pdf_fit(var, eigen_observations, tn_relation, kde_bwidth, num_points=1000):
            ...
            empirical_pdf = fit_kde(eigen_observations, kde_bwidth, eval_points=theoretical_pdf.index.values)
        ...
        def find_max_eval(eigen_observations, tn_relation, kde_bwidth):
            ...
            optimization = minimize(pdf_fit, x0=np.array(0.5), args=(eigen_observations, tn_relation, kde_bwidth),
                                    bounds=((1e-5, 1 - 1e-5),))
        ...
        def denoised_corr(eigenvalues, eigenvectors, num_facts):
            """
            ...
            cov_to_corr_func = cov_to_corr
            corr = cov_to_corr_func(cov)
        ...
        maximum_eigen, _ = find_max_eval(np.diag(eigenval), tn_relation, kde_bwidth)
        ...
        corr = denoised_corr(eigenval, eigenvec, num_facts)
