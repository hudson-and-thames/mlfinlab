...
class TestReturnOverBenchmark(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        test3 = return_over_benchmark(data3[:10], benchmark=0.005)
    ...
    def test_given_benchmark(self):
        ...
        data4 = self.data['BND']
        test4 = return_over_benchmark(data4[:10], benchmark=benchmark4)
        test5 = return_over_benchmark(data4[:10], benchmark=benchmark4, binary=True)
    ...
    def test_warning(self):
        """
        Verifies that the correct warning is given when there is a mismatch between prices.index and benchmark.index.
        """
