...
class TestDataStructures(unittest.TestCase):
    ...
    def test_dollar_bars(self):
        ...
        db1 = ds.get_dollar_bars('./test_data/tick_data.csv', threshold=threshold, batch_size=100)
        db2 = ds.get_dollar_bars('./test_data/tick_data.csv', threshold=threshold, batch_size=50)
        db3 = ds.get_dollar_bars('./test_data/tick_data.csv', threshold=threshold, batch_size=10)
