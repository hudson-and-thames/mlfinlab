...
class TesStructuralBreaks(unittest.TestCase):
    ...
    def test_chow_test(self):
        ...
        stats = get_chow_type_stat(log_prices, min_length=min_length, verbose=False)
    ...
    def test_chu_stinchcombe_white_test(self):
        ...
        log_prices = np.log(self.data.close)
        one_sided_test = get_chu_stinchcombe_white_statistics(log_prices, test_type='one_sided', verbose=False)
        two_sided_test = get_chu_stinchcombe_white_statistics(log_prices, test_type='two_sided', verbose=False)
